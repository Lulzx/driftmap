...
from vpfm.simulation import Simulation, vortex_pair, lamb_oseen
from vpfm.diagnostics import find_vortex_peak
...
def run_comparison(nx=128, n_steps=2000, dt=0.01):
    ...
    plt.tight_layout()
    plt.savefig('leapfrog_comparison.png', dpi=150)
    print(f"\nPlot saved to leapfrog_comparison.png")
    plt.show()
